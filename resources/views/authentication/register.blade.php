	...
	<div class="row">
		<div class="col-md-6 col-md-offset-3">
			<div class="panel panel-info">
			  	<div class="panel-heading"><h4>Student Registration</h4></div>
			  	<div class="panel-body">

			  		<form action="/register" method="POST" method="POST" name="register" onsubmit="return validateForm()">
			  			{{csrf_field()}}
						...
						<div class="form-group">
						    <div class="input-group" style="margin: 5px">
						      ...
						      <input id="users_id" type="number" class="form-control" name="users_id" placeholder="Registration No" required>
						    </div>
						</div>
						<!-- for email -->
						<div class="form-group">
